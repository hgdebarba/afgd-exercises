...
namespace AfGD.Execise3
{
    ...
    public class PathFindingEditor : Editor
    {
        ...
        SerializedProperty m_AlgorithmProperty;
        ...
        void OnEnable()
        {
            ...
            m_AlgorithmProperty = serializedObject.FindProperty("m_Algorithm");
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Display property fields for the Algorithms and Graph.
            // Property automatically figures out what kind of field it should display.
            EditorGUILayout.PropertyField(m_AlgorithmProperty);
