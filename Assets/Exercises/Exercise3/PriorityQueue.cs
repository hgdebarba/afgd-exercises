...
{
    // Wrapper around Microsofts implementation for a priority queue.
    ...
    public class PriorityQueue<T>
    {
        ...
        class ElementComparer : IComparer<PrioritizedElement>
        {
            public int Compare(PrioritizedElement x, PrioritizedElement y)
            {
...
//https://docs.microsoft.com/en-us/dotnet/api/system.collections.icomparer?view=net-5.0
...
namespace MS.Internal
{
    ...
    /// </remarks>
    internal class PriorityQueueImpl<T>
    {
        //
        ...
        internal PriorityQueueImpl(int capacity, IComparer<T> comparer)
        {
